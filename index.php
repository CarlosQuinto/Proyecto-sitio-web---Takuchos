...
<body>
    ...
    <div class="col-lg-12">
        <center>
            <div id="mapa-ubicacion" class="col-lg-6">
                <h4 class="col-lg-12" style="margin-bottom: 10px;">
                    Localizanos en: 
                </h4>
                <div class="col-lg-12" style="margin-bottom: 20px;">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3525.1777094593194!2d-110.92804988536858!3d27.927196822403687!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x86c97a94bb1b4207%3A0x9601736253a9bd18!2sLos+Takuchos!5e0!3m2!1ses-419!2smx!4v1525798938136" width="300" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>  
        ...
        <center>
            <div class="col-lg-6">
                <h4 class="col-lg-12" style="margin-bottom: 18px;">
                     Disfruta de los mejores tacos de la region.
                </h4>

                <div id="contenedor-slider" class="contenedor-slider"  style="margin-bottom: 20px;">

                 <div id="slider" class="slider col-lg-12">
